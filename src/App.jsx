        ...
        <div className="controls">
          <div className="dropdown">
            ...
            <div className="dropdown-content">
              <button onClick={() => { gridRef.current.generateRecursiveMaze(); clearResults(); }}>Recursive Division</button>
              <button onClick={() => { gridRef.current.generateRandomMaze(); clearResults(); }}>Random Walls</button>
            </div>
          </div>
